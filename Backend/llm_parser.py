...
- "بالسيارة" / "بالسياره" / "بالعربية" / "بالسياره" = by car (القيادة)
- "مشي" / "سير" / "على الاقدام" = walking
- أمثلة: "15 د بالسياره" = 15 minutes by car
- أمثلة: "10 دقائق بالسيارة" = 10 minutes by car
- أمثلة: "قريبه من الجامعه" = near the university

## أسماء الجامعات (مهم جداً):
- استخرج اسم الجامعة كما ذكره المستخدم بالضبط
- لا تقلق من الاختلافات الإملائية البسيطة (التاء المربوطة/الهاء، الهمزات، النقاط)
- أمثلة:
  * "جامعة الاميره نوره" = استخرج "جامعة الاميره نوره" (سيتم التطبيع لاحقاً)
  * "جامعه الملك سعود" = استخرج "جامعه الملك سعود"
  * "جامعة الامام محمد بن سعود" = استخرج "جامعة الامام محمد بن سعود"
  * "الملك سعود" = استخرج "الملك سعود" (يكفي الاسم المختصر)
...
10. إذا ذكر المستخدم جامعة معينة، استخرج اسمها في university_requirements.university_name
11. إذا ذكر وقت محدد للوصول للجامعة (مثل "15 دقيقة"), ضعه في university_requirements.max_distance_minutes
12. الوقت الافتراضي للجامعات: 15 دقيقة بالسيارة إذا لم يُذكر
13. افهم جميع أشكال الكلمات (تاء مربوطة، هاء، مع أو بدون همزات ونقاط)
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "university_requirements": {
                            ...
                            "properties": {
                                "required": {"type": "boolean"},
                                "university_name": {"type": "string", "description": "اسم الجامعة"},
