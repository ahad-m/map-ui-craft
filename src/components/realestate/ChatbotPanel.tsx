 ...
 * 
 * AI-powered real estate chatbot interface
 * Provides conversational property search with voice input support
 * 
 * @module components/realestate/ChatbotPanel
 */
 ...
 * ChatbotPanel Component
 * 
 * Renders an AI chatbot interface with:
 * - Message history
 * - Voice input support
