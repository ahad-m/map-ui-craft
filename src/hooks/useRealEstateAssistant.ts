...
export interface UseRealEstateAssistantReturn {
  ...
  resetChat: () => void; // [تعديل] تم تغيير الاسم من clearChat إلى resetChat
}
...
export function useRealEstateAssistant(): UseRealEstateAssistantReturn {
  ...
  // [تعديل] تغيير الاسم إلى resetChat ليتوافق مع الواجهة
  ...
  return {
    ...
    sendMessage,
    selectSearchMode,
    resetChat, // [تعديل] تصدير الدالة بالاسم الجديد
  };
}
