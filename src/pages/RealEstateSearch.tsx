  ...
  useEffect(() => {
    ...
    properties.forEach((property) => {
      ...
      el.innerHTML = `
        ...
        ">
          <div style="font-size: 10px; font-weight: bold; color: #16a34a;">${property.price} SAR</div>
          <div style="font-size: 8px; color: #666;">${property.type} • ${property.bedrooms} BR</div>
        </div>
      `;
          ...
          new mapboxgl.Popup({ offset: 25 })
            .setHTML(`
              <div style="padding: 8px;">
                <h3 style="font-weight: bold; margin-bottom: 4px;">${property.type}</h3>
                <p style="font-size: 14px; color: #16a34a; font-weight: bold;">${property.price} SAR</p>
                <p style="font-size: 12px; color: #666;">${property.bedrooms} Bedrooms • ${property.area}m²</p>
              </div>
            `)
        )
        .addTo(map.current!);
        ...
        <Card className="p-8 max-w-md w-full space-y-6 shadow-elegant border-0 bg-gradient-to-b from-card to-card/50 backdrop-blur-sm">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your Mapbox access token to get started
            </p>
          </div>
